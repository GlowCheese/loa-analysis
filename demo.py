...
for function_name, (fitness_func, LIMIT, EV) in all_functions.items():
    ...
    for python_file_name in tqdm(os.listdir(algorithms_folder), function_name, leave=False, smoothing=False):
    ...
    if results['loa'] == winner[1]: winner[0] = 'loa'
    if results['loa2'] == winner[1]: winner[0] = 'loa2'
